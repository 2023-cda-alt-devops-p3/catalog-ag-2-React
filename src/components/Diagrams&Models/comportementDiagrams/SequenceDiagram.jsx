...
const SequenceDiagram = () => {
    ...
    return (
        <article class="article" id="diagramme-de-sequence-UML">
            ...
            <ol>
                <li>- <i>Scénario d'utilisation</i> : un scénario d'utilisation est un diagramme décrivant comment votre
                ...
                <li>- <i>Logique de méthode</i> : de la même façon que vous pouvez utiliser un diagramme de séquence UML
                ...
                <li>- <i>Logique de service</i> : si vous considérez un service comme étant une méthode générale utilisée
